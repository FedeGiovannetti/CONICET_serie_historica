...
```{r total doctorales KS generales barras apiladas, fig.width= 8}
  ...
  datos_ks %>% 
    ...
    labs(y = "Cantidad", x = "Convocatoria",
       ...
       caption = "Nota. Los valores faltantes no se encuentran disponibles públicamente")+
    geom_text(aes(label = "@fedegiovannetti @fernarso", x = 2019.2, y = 1700), size = 5, alpha = 0.3, hjust = 0.4, color = "Grey40")+
  scale_fill_pastel()
...
```{r total doctorales KS estrategicos barras apiladas, fig.width= 8}
  ...
  datos_ks %>% 
    ...
    labs(y = "Cantidad", x = "Convocatoria", 
       ...
       caption = "Nota. Los valores faltantes no se encuentran disponibles públicamente")+
    geom_text(aes(label = "@fedegiovannetti @fernarso", x = 2019.2, y = 350), size = 5, alpha = 0.2, hjust = 0.4, color = "Grey40")+
  scale_fill_pastel()
...
```{r total postdoctorales KS generales barras apiladas, fig.width= 8}
  ...
  datos_ks %>% 
    ...
    labs(y = "Cantidad", x = "Convocatoria",
       ...
       caption = "Nota. Los valores faltantes no se encuentran disponibles públicamente")+
    geom_text(aes(label = "@fedegiovannetti @fernarso", x = 2019.2, y = 650), size = 5, alpha = 0.2, hjust = 0.4, color = "Grey40")+
  scale_fill_pastel()
...
```{r total postdoctorales KS estrategicos barras apiladas, fig.width= 8}
  ...
  datos_ks %>% 
    ...
    labs(y = "Cantidad", x = "Convocatoria",
       ...
       caption = "Nota. Los valores faltantes no se encuentran disponibles públicamente")+
    geom_text(aes(label = "@fedegiovannetti @fernarso", x = 2019.2, y = 170), size = 5, alpha = 0.2, hjust = 0.4, color = "Grey40")+
  scale_fill_pastel()
